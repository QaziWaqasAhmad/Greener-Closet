...
import { createCategory, createMaterial } from "../../../services/products/Products";
...
export default function MaterialModal({
  ...
  const handleAddCeheck=()=>{
      ...
      createMaterial(body,adminRole.token).then((response)=>{
      ...
      >
        <Box sx={style}>
         <div className="-category_modal">
          ...
          <h5 className="text-white">ADD MATERIAL</h5>
