...
import { createCategory, updateCategory, updateDepartment } from "../../../services/products/Products";
...
export default function DepartmentEditModal({
  ...
  const handleAddCeheck=()=>{
      ...
      updateDepartment(data?._id,body,adminRole.token).then((response)=>{
      ...
      >
        <Box sx={style}>
         <div className="-category_modal">
          ...
          <h5 className="text-white">UPDATE CATEGORY</h5>
